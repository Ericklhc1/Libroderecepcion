...
export function RoomCard({
  ...
  return (
    <div className="card overflow-hidden transition-shadow hover:shadow-md focus-within:shadow-md">
      <Link href={`/habitaciones/${room.number}`} className="block p-3">
      ...
      {gymHref ? (
        <div className="border-t border-slate-100 bg-slate-50/70 px-3 py-2 no-print">
          <Link
            href={gymHref}
