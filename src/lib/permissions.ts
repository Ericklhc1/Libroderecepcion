...
export const PERMISSIONS = {
  ...
  */
  ...
  'supervision.task.assign': { group: 'Centro de Supervisión', name: 'Asignar tareas desde Supervisión' },
  'supervision.task.validate': { group: 'Centro de Supervisión', name: 'Validar y devolver tareas realizadas' },
  'supervision.followup.manage': { group: 'Centro de Supervisión', name: 'Administrar seguimientos de Supervisión' },
  'supervision.note.private': { group: 'Centro de Supervisión', name: 'Crear y consultar notas privadas propias' },
  'supervision.note.share': { group: 'Centro de Supervisión', name: 'Compartir notas con Supervisión u Operación' },
  'supervision.audit.create': { group: 'Centro de Supervisión', name: 'Crear auditorías sorpresa' },
  'supervision.audit.close': { group: 'Centro de Supervisión', name: 'Cerrar auditorías sorpresa' },
  'supervision.audit.reserved': { group: 'Centro de Supervisión', name: 'Ver auditorías reservadas' },
  'supervision.corrective.manage': { group: 'Centro de Supervisión', name: 'Crear y validar medidas correctivas' },
  'supervision.performance.view': { group: 'Centro de Supervisión', name: 'Ver indicadores del equipo' },
  'supervision.performance.comment': { group: 'Centro de Supervisión', name: 'Añadir observaciones de rendimiento' },
  'supervision.history.view': { group: 'Centro de Supervisión', name: 'Consultar el historial completo de Supervisión' },
...
export const ROLE_PERMISSIONS: Record<RoleKey, PermissionKey[]> = {
  ...
  */
  ...
  [ROLE_KEYS.SUPERVISOR]: [
    ...
    'supervision.task.validate',
    'supervision.followup.manage',
    'supervision.note.private',
    'supervision.note.share',
    'supervision.audit.create',
    'supervision.audit.close',
    'supervision.audit.reserved',
    'supervision.corrective.manage',
    'supervision.performance.view',
    'supervision.performance.comment',
