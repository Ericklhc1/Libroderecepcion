...
export async function resetOperationalData() {
  ...
  await prisma.$transaction([
    ...
    prisma.auditParticipant.deleteMany(),
    ...
    prisma.supervisionShiftHandover.deleteMany(),
    prisma.supervisionShift.deleteMany(),
